...
Text = \lyricmode {
  sjung du min dal med
  brin -- nan -- de röst
  tyst di -- na he -- ta sång -- er
  sjung mark -- ens gräs å su -- sa vart träd
  sak -- ta om dag -- en som kom -- mer
  sjung käl -- la å flod sjung sten -- ar å jord
  ge oss till tröst di -- na sång -- er
  å sjung du min dal å brinn i din tro
  på fri -- het -- ens dag som kom -- mer!
}
